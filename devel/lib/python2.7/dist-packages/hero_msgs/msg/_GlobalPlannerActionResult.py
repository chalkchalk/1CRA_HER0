...
"""autogenerated by genpy from hero_msgs/GlobalPlannerActionResult.msg. Do not edit."""
import sys
...
class GlobalPlannerActionResult(genpy.Message):
  _md5sum = "363a8255aae19ae465319475e1a86dad"
  _type = "hero_msgs/GlobalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hero_msgs/GlobalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GlobalPlannerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hero_msgs.msg.GlobalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hero_msgs.msg.GlobalPlannerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.error_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.error_code,) = _get_struct_i().unpack(str[start:end])
      return self
