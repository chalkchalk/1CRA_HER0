...
"""autogenerated by genpy from hero_msgs/GlobalPlannerFeedback.msg. Do not edit."""
import sys
...
class GlobalPlannerFeedback(genpy.Message):
  _md5sum = "f3dbb0203aeb8ca03ec5019146bf73fa"
  _type = "hero_msgs/GlobalPlannerFeedback"
...
float64 w
"""
  __slots__ = ['path','error_code','error_msg']
  _slot_types = ['nav_msgs/Path','int32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GlobalPlannerFeedback, self).__init__(*args, **kwds)
