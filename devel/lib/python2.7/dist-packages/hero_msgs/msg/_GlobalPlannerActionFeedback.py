...
"""autogenerated by genpy from hero_msgs/GlobalPlannerActionFeedback.msg. Do not edit."""
import sys
...
class GlobalPlannerActionFeedback(genpy.Message):
  _md5sum = "8130df27aee37e22f7e0f550ecc79747"
  _type = "hero_msgs/GlobalPlannerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hero_msgs/GlobalPlannerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GlobalPlannerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hero_msgs.msg.GlobalPlannerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hero_msgs.msg.GlobalPlannerFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.feedback.path.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.path.poses:
        _v1 = val1.header
      ...
      buff.write(_get_struct_i().pack(self.feedback.error_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feedback.path.poses.append(val1)
      start = end
      end += 4
      (self.feedback.error_code,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
