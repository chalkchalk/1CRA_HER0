...
"""autogenerated by genpy from hero_msgs/LocalPlannerActionResult.msg. Do not edit."""
import sys
...
class LocalPlannerActionResult(genpy.Message):
  _md5sum = "363a8255aae19ae465319475e1a86dad"
  _type = "hero_msgs/LocalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hero_msgs/LocalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalPlannerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hero_msgs.msg.LocalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hero_msgs.msg.LocalPlannerResult()
