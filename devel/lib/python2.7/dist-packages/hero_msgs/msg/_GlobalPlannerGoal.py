...
"""autogenerated by genpy from hero_msgs/GlobalPlannerGoal.msg. Do not edit."""
import sys
...
class GlobalPlannerGoal(genpy.Message):
  _md5sum = "989550e592ae95fe389e96a6250048dc"
  _type = "hero_msgs/GlobalPlannerGoal"
...
float64 w
"""
  __slots__ = ['command','start_specific','start','goal']
  _slot_types = ['int32','bool','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       command,start_specific,start,goal
    ...
    """
    if args or kwds:
      super(GlobalPlannerGoal, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.command is None:
        self.command = 0
      if self.start_specific is None:
        self.start_specific = False
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_iB3I().pack(_x.command, _x.start_specific, _x.start.header.seq, _x.start.header.stamp.secs, _x.start.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.command, _x.start_specific, _x.start.header.seq, _x.start.header.stamp.secs, _x.start.header.stamp.nsecs,) = _get_struct_iB3I().unpack(str[start:end])
      self.start_specific = bool(self.start_specific)
      start = end
      end += 4
