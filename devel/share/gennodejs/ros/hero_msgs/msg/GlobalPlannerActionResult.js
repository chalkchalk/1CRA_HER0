...
class GlobalPlannerActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GlobalPlannerResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GlobalPlannerActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = GlobalPlannerResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GlobalPlannerActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GlobalPlannerResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GlobalPlannerResult()
    }
...
module.exports = GlobalPlannerActionResult;
