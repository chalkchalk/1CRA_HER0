...
class GlobalPlannerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GlobalPlannerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GlobalPlannerActionFeedback(null);
    ...
    data.feedback = GlobalPlannerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GlobalPlannerFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GlobalPlannerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GlobalPlannerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GlobalPlannerFeedback()
    }
...
module.exports = GlobalPlannerActionFeedback;
