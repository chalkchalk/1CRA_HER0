...
class LocalPlannerActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LocalPlannerGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LocalPlannerGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalPlannerActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LocalPlannerGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LocalPlannerGoal()
    }
...
module.exports = LocalPlannerActionGoal;
