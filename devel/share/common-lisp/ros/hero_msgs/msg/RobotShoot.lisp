...
(cl:defmethod cl:initialize-instance :after ((m <RobotShoot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotShoot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hero_msgs-msg:<RobotShoot> is deprecated: use hero_msgs-msg:RobotShoot instead.")))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <RobotShoot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hero_msgs-msg:frequency-val is deprecated.  Use hero_msgs-msg:frequency instead.")
  (frequency m))
