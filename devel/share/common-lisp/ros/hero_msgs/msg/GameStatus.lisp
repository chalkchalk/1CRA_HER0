...
(cl:defmethod cl:initialize-instance :after ((m <GameStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GameStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hero_msgs-msg:<GameStatus> is deprecated: use hero_msgs-msg:GameStatus instead.")))

(cl:ensure-generic-function 'game_status-val :lambda-list '(m))
(cl:defmethod game_status-val ((m <GameStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hero_msgs-msg:game_status-val is deprecated.  Use hero_msgs-msg:game_status instead.")
  (game_status m))

(cl:ensure-generic-function 'remaining_time-val :lambda-list '(m))
(cl:defmethod remaining_time-val ((m <GameStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hero_msgs-msg:remaining_time-val is deprecated.  Use hero_msgs-msg:remaining_time instead.")
  (remaining_time m))
