...
(cl:defclass <GlobalPlannerGoal> (roslisp-msg-protocol:ros-message)
  ((command
    ...
    :initform 0)
   (start_specific
    :reader start_specific
    :initarg :start_specific
    :type cl:boolean
    :initform cl:nil)
   (start
    :reader start
...
(cl:defmethod cl:initialize-instance :after ((m <GlobalPlannerGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalPlannerGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hero_msgs-msg:<GlobalPlannerGoal> is deprecated: use hero_msgs-msg:GlobalPlannerGoal instead.")))
...
(cl:ensure-generic-function 'start_specific-val :lambda-list '(m))
(cl:defmethod start_specific-val ((m <GlobalPlannerGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hero_msgs-msg:start_specific-val is deprecated.  Use hero_msgs-msg:start_specific instead.")
  (start_specific m))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <GlobalPlannerGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hero_msgs-msg:start-val is deprecated.  Use hero_msgs-msg:start instead.")
  (start m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GlobalPlannerGoal>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'start_specific) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GlobalPlannerGoal>) istream)
  "Deserializes a message object of type '<GlobalPlannerGoal>"
    ...
    (cl:setf (cl:slot-value msg 'start_specific) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GlobalPlannerGoal>)))
  ...
  "989550e592ae95fe389e96a6250048dc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GlobalPlannerGoal)))
  "Returns md5sum for a message object of type 'GlobalPlannerGoal"
  "989550e592ae95fe389e96a6250048dc")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GlobalPlannerGoal>))
  ...
  (cl:list 'GlobalPlannerGoal
    ...
    (cl:cons ':start_specific (start_specific msg))
