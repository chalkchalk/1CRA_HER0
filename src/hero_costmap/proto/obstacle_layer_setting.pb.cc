...
void protobuf_AddDesc_obstacle_5flayer_5fsetting_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\020\n\010is_debug\030\016 \002(\010", 417);
...
ParaObstacleLayer::ParaObstacleLayer()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_costmap.ParaObstacleLayer)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:hero_costmap.ParaObstacleLayer)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_costmap.ParaObstacleLayer)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_costmap.ParaObstacleLayer)
  return false;
#undef DO_
}
...
void ParaObstacleLayer::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:hero_costmap.ParaObstacleLayer)
  // required double observation_keep_time = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_costmap.ParaObstacleLayer)
}
