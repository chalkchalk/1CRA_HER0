...
ParaInflationLayer::ParaInflationLayer()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_costmap.ParaInflationLayer)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:hero_costmap.ParaInflationLayer)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_costmap.ParaInflationLayer)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_costmap.ParaInflationLayer)
  return false;
#undef DO_
}
...
void ParaInflationLayer::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:hero_costmap.ParaInflationLayer)
  // required double inflation_radius = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_costmap.ParaInflationLayer)
}
