...
ParaStaticLayer::ParaStaticLayer()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_costmap.ParaStaticLayer)
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:hero_costmap.ParaStaticLayer)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_costmap.ParaStaticLayer)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_costmap.ParaStaticLayer)
  return false;
#undef DO_
}
...
void ParaStaticLayer::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:hero_costmap.ParaStaticLayer)
  // required bool first_map_only = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_costmap.ParaStaticLayer)
}
