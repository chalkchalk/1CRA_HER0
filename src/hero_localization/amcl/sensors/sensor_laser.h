...
#ifndef HERO_LOCALIZATION_AMCL_SENSORS_SENSOR_LASER_H
#define HERO_LOCALIZATION_AMCL_SENSORS_SENSOR_LASER_H
...
#endif //HERO_LOCALIZATION_AMCL_SENSORS_SENSOR_LASER_H
