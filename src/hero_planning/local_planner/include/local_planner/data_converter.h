...
#ifndef HERO_PLANNING_LOCAL_PLANNER_DATA_CONVERTER_H_
#define HERO_PLANNING_LOCAL_PLANNER_DATA_CONVERTER_H_
...
class DataConverter {
 public:
  /**
   * @brief Convert hero_costmap::RobotPose to std::pair<Eigen::Vector2d, double>
   * @param pose Data structure of hero_costmap::RobotPose
   * @return Data structure of std::pair<Eigen::Vector2d, double>
   */
  static std::pair<Eigen::Vector2d, double> LocalConvertRMData(const hero_costmap::RobotPose &pose) {
...
#endif //HERO_PLANNING_LOCAL_PLANNER_DATA_CONVERTER_H_
