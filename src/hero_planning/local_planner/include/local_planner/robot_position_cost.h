...
#ifndef HERO_PLANNING_LOCAL_PLANNER_ROBOT_POSITION_COST_H
#define HERO_PLANNING_LOCAL_PLANNER_ROBOT_POSITION_COST_H
...
class RobotPositionCost {
 public:
   ...
   */
  RobotPositionCost(const hero_costmap::Costmap2D& cost_map);
  /**
   * @brief Destructor
   */
  ~RobotPositionCost();
 ...
 private:
  //! Cost map
  const hero_costmap::Costmap2D& costmap_;
};
...
#endif //HERO_PLANNING_LOCAL_PLANNER_ROBOT_POSITION_COST_H
