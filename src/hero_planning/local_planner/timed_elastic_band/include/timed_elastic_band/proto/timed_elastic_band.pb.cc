...
void protobuf_AddDesc_timed_5felastic_5fband_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\030timed_elastic_band.proto\022\022hero_local_p"
    ...
    "\003 \001(\002\022)\n!global_plan_overwrite_orientati"
    "on\030\004 \001(\010\022(\n allow_init_with_backwards_mo"
    "tion\030\005 \001(\010\022 \n\030global_plan_viapoint_sep\030\006"
    " \001(\002\022\032\n\022via_points_ordered\030\007 \001(\010\022&\n\036max_"
    "global_plan_lookahead_dist\030\010 \001(\002\022\030\n\020exac"
    "t_arc_length\030\t \001(\010\022\"\n\032force_reinit_new_g"
    "oal_dist\030\n \001(\002\022\"\n\032feasibility_check_no_p"
    "oses\030\013 \001(\003\022\030\n\020publish_feedback\030\014 \001(\010\022\023\n\013"
    "min_samples\030\r \001(\003\022\023\n\013max_samples\030\016 \001(\003\"\274"
    "\002\n\016FootprintModel\022>\n\004type\030\001 \001(\01620.hero_l"
    "ocal_planner.FootprintModel.FootprintTyp"
    "e\022\016\n\006radius\030\002 \001(\001\022\024\n\014front_offset\030\003 \001(\001\022"
    "\024\n\014front_radius\030\004 \001(\001\022\023\n\013rear_offset\030\005 \001"
    "(\001\022\023\n\013rear_radius\030\006 \001(\001\0223\n\016robot_vertice"
    "s\030\007 \003(\0132\033.hero_local_planner.Point2D\"O\n\r"
    ...
    "backwards\030\002 \001(\002\022\021\n\tmax_vel_y\030\003 \001(\002\022\025\n\rma"
    "x_vel_theta\030\004 \001(\002\022\021\n\tacc_lim_x\030\005 \001(\002\022\021\n\t"
    ...
    "]\n\rGoalTolerance\022\031\n\021xy_goal_tolerance\030\001 "
    "\001(\002\022\032\n\022yaw_goal_tolerance\030\002 \001(\002\022\025\n\rfree_"
    "goal_vel\030\003 \001(\010\"\236\003\n\tObstacles\022\031\n\021min_obst"
    "acle_dist\030\001 \001(\002\022\026\n\016inflation_dist\030\002 \001(\002\022"
    "!\n\031include_costmap_obstacles\030\003 \001(\010\022+\n#co"
    "stmap_obstacles_behind_robot_dist\030\004 \001(\002\022"
    "\037\n\027obstacle_poses_affected\030\005 \001(\002\022#\n\033lega"
    "cy_obstacle_association\030\006 \001(\010\022*\n\"obstacl"
    "e_association_cutoff_factor\030\007 \001(\002\0223\n+obs"
    "tacle_association_force_inclusion_factor"
    "\030\010 \001(\002\022 \n\030costmap_converter_plugin\030\t \001(\t"
    "\022%\n\035costmap_converter_spin_thread\030\n \001(\010\022"
    "\036\n\026costmap_converter_rate\030\013 \001(\002\"\224\005\n\014Opti"
    ...
    "im_theta\030\026 \001(\002\"\201\005\n\024HomotopyClassPlanner\022"
    "&\n\036enable_homotopy_class_planning\030\001 \001(\010\022"
    "\035\n\025enable_multithreading\030\002 \001(\010\022\032\n\022simple"
    "_exploration\030\003 \001(\010\022\032\n\022max_number_classes"
    "\030\004 \001(\005\022!\n\031selection_obst_cost_scale\030\005 \001("
    "\002\022%\n\035selection_prefer_initial_plan\030\006 \001(\002"
    "\022%\n\035selection_viapoint_cost_scale\030\007 \001(\002\022"
    "!\n\031selection_cost_hysteresis\030\010 \001(\002\022\'\n\037se"
    "lection_alternative_time_cost\030\t \001(\010\022 \n\030r"
    "oadmap_graph_no_samples\030\n \001(\005\022 \n\030roadmap"
    "_graph_area_width\030\013 \001(\005\022\'\n\037roadmap_graph"
    "_area_length_scale\030\014 \001(\002\022\035\n\025h_signature_"
    "prescaler\030\r \001(\002\022\035\n\025h_signature_threshold"
    "\030\016 \001(\002\022 \n\030obstacle_keypoint_offset\030\017 \001(\002"
    "\022\"\n\032obstacle_heading_threshold\030\020 \001(\002\022 \n\030"
    "viapoints_all_candidates\030\021 \001(\010\022\032\n\022visual"
    "ize_hc_graph\030\022 \001(\010\"\366\001\n\010Recovery\022#\n\033shrin"
    "k_horizon_min_duration\030\001 \001(\010\022\034\n\024oscillat"
    "ion_recovery\030\002 \001(\010\022\035\n\025shrink_horizon_bac"
    "kup\030\003 \001(\010\022\031\n\021oscillation_v_eps\030\004 \001(\001\022\035\n\025"
    "oscillation_omega_eps\030\005 \001(\001\022)\n!oscillati"
    "on_recovery_min_duration\030\006 \001(\001\022#\n\033oscill"
    "ation_filter_duration\030\007 \001(\001\"\364\003\n\006Config\022."
    "\n\topt_frame\030\001 \001(\0132\033.hero_local_planner.F"
    "rameID\0226\n\016trajectory_opt\030\002 \001(\0132\036.hero_lo"
    "cal_planner.Trajectory\0221\n\016kinematics_opt"
    "\030\003 \001(\0132\031.hero_local_planner.Robot\0228\n\rtol"
    "erance_opt\030\004 \001(\0132!.hero_local_planner.Go"
    "alTolerance\0224\n\robstacles_opt\030\005 \001(\0132\035.her"
    "o_local_planner.Obstacles\0227\n\roptimize_in"
    "fo\030\006 \001(\0132 .hero_local_planner.Optimizati"
    "on\0229\n\007hcp_opt\030\007 \001(\0132(.hero_local_planner"
    ".HomotopyClassPlanner\0226\n\nrobot_type\030\010 \003("
    "\0132\".hero_local_planner.FootprintModel\0223\n"
    "\rrecovery_info\030\t \001(\0132\034.hero_local_planne"
    "r.Recovery", 3690);
...
FrameID::FrameID()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.FrameID)
}
...
FrameID::FrameID(const FrameID& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.FrameID)
}
...
FrameID::~FrameID() {
  // @@protoc_insertion_point(destructor:hero_local_planner.FrameID)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:hero_local_planner.FrameID)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.FrameID)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.FrameID)
  return false;
#undef DO_
}
...
void FrameID::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:hero_local_planner.FrameID)
  // optional string odom_frame = 1;
  if (has_odom_frame()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->odom_frame().data(), this->odom_frame().length(),
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.FrameID)
}

::google::protobuf::uint8* FrameID::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.FrameID)
  // optional string odom_frame = 1;
  if (has_odom_frame()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->odom_frame().data(), this->odom_frame().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.FrameID)
  return target;
}
...
Point2D::Point2D()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Point2D)
}
...
Point2D::Point2D(const Point2D& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Point2D)
}
...
Point2D::~Point2D() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Point2D)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Point2D)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Point2D)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Point2D)
  return false;
#undef DO_
}
...
void Point2D::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Point2D)
  // optional float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Point2D)
}

::google::protobuf::uint8* Point2D::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Point2D)
  // optional float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Point2D)
  return target;
}
...
Trajectory::Trajectory()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Trajectory)
}
...
Trajectory::Trajectory(const Trajectory& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Trajectory)
}
...
Trajectory::~Trajectory() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Trajectory)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Trajectory)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Trajectory)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Trajectory)
  return false;
#undef DO_
}
...
void Trajectory::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Trajectory)
  // optional bool teb_autosize = 1;
  if (has_teb_autosize()) {
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Trajectory)
}

::google::protobuf::uint8* Trajectory::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Trajectory)
  // optional bool teb_autosize = 1;
  if (has_teb_autosize()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Trajectory)
  return target;
}
...
FootprintModel::FootprintModel()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.FootprintModel)
}
...
FootprintModel::FootprintModel(const FootprintModel& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.FootprintModel)
}
...
FootprintModel::~FootprintModel() {
  // @@protoc_insertion_point(destructor:hero_local_planner.FootprintModel)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.FootprintModel)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::hero_local_planner::FootprintModel_FootprintType_IsValid(value)) {
            set_type(static_cast< ::hero_local_planner::FootprintModel_FootprintType >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.FootprintModel)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.FootprintModel)
  return false;
#undef DO_
}
...
void FootprintModel::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.FootprintModel)
  // optional .hero_local_planner.FootprintModel.FootprintType type = 1;
  if (has_type()) {
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.FootprintModel)
}

::google::protobuf::uint8* FootprintModel::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.FootprintModel)
  // optional .hero_local_planner.FootprintModel.FootprintType type = 1;
  if (has_type()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.FootprintModel)
  return target;
}
...
Robot::Robot()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Robot)
}
...
Robot::Robot(const Robot& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Robot)
}
...
Robot::~Robot() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Robot)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Robot)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Robot)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Robot)
  return false;
#undef DO_
}
...
void Robot::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Robot)
  // optional float max_vel_x = 1;
  if (has_max_vel_x()) {
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Robot)
}

::google::protobuf::uint8* Robot::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Robot)
  // optional float max_vel_x = 1;
  if (has_max_vel_x()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Robot)
  return target;
}
...
GoalTolerance::GoalTolerance()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.GoalTolerance)
}
...
GoalTolerance::GoalTolerance(const GoalTolerance& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.GoalTolerance)
}
...
GoalTolerance::~GoalTolerance() {
  // @@protoc_insertion_point(destructor:hero_local_planner.GoalTolerance)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.GoalTolerance)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.GoalTolerance)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.GoalTolerance)
  return false;
#undef DO_
}
...
void GoalTolerance::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.GoalTolerance)
  // optional float xy_goal_tolerance = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.GoalTolerance)
}

::google::protobuf::uint8* GoalTolerance::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.GoalTolerance)
  // optional float xy_goal_tolerance = 1;
  if (has_xy_goal_tolerance()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.GoalTolerance)
  return target;
}
...
Obstacles::Obstacles()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Obstacles)
}
...
Obstacles::Obstacles(const Obstacles& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Obstacles)
}
...
Obstacles::~Obstacles() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Obstacles)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Obstacles)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Obstacles)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Obstacles)
  return false;
#undef DO_
}
...
void Obstacles::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Obstacles)
  // optional float min_obstacle_dist = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Obstacles)
}

::google::protobuf::uint8* Obstacles::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Obstacles)
  // optional float min_obstacle_dist = 1;
  if (has_min_obstacle_dist()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Obstacles)
  return target;
}
...
Optimization::Optimization()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Optimization)
}
...
Optimization::Optimization(const Optimization& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Optimization)
}
...
Optimization::~Optimization() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Optimization)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Optimization)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Optimization)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Optimization)
  return false;
#undef DO_
}
...
void Optimization::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Optimization)
  // optional int32 no_inner_iterations = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Optimization)
}

::google::protobuf::uint8* Optimization::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Optimization)
  // optional int32 no_inner_iterations = 1;
  if (has_no_inner_iterations()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Optimization)
  return target;
}
...
HomotopyClassPlanner::HomotopyClassPlanner()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.HomotopyClassPlanner)
}
...
HomotopyClassPlanner::HomotopyClassPlanner(const HomotopyClassPlanner& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.HomotopyClassPlanner)
}
...
HomotopyClassPlanner::~HomotopyClassPlanner() {
  // @@protoc_insertion_point(destructor:hero_local_planner.HomotopyClassPlanner)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.HomotopyClassPlanner)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(16383);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.HomotopyClassPlanner)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.HomotopyClassPlanner)
  return false;
#undef DO_
}
...
void HomotopyClassPlanner::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.HomotopyClassPlanner)
  // optional bool enable_homotopy_class_planning = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.HomotopyClassPlanner)
}

::google::protobuf::uint8* HomotopyClassPlanner::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.HomotopyClassPlanner)
  // optional bool enable_homotopy_class_planning = 1;
  if (has_enable_homotopy_class_planning()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.HomotopyClassPlanner)
  return target;
}
...
Recovery::Recovery()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Recovery)
}
...
Recovery::Recovery(const Recovery& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Recovery)
}
...
Recovery::~Recovery() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Recovery)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Recovery)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Recovery)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Recovery)
  return false;
#undef DO_
}
...
void Recovery::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Recovery)
  // optional bool shrink_horizon_min_duration = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Recovery)
}

::google::protobuf::uint8* Recovery::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Recovery)
  // optional bool shrink_horizon_min_duration = 1;
  if (has_shrink_horizon_min_duration()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Recovery)
  return target;
}
...
Config::Config()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_local_planner.Config)
}

void Config::InitAsDefaultInstance() {
  opt_frame_ = const_cast< ::hero_local_planner::FrameID*>(&::hero_local_planner::FrameID::default_instance());
  trajectory_opt_ = const_cast< ::hero_local_planner::Trajectory*>(&::hero_local_planner::Trajectory::default_instance());
  kinematics_opt_ = const_cast< ::hero_local_planner::Robot*>(&::hero_local_planner::Robot::default_instance());
  tolerance_opt_ = const_cast< ::hero_local_planner::GoalTolerance*>(&::hero_local_planner::GoalTolerance::default_instance());
  obstacles_opt_ = const_cast< ::hero_local_planner::Obstacles*>(&::hero_local_planner::Obstacles::default_instance());
  optimize_info_ = const_cast< ::hero_local_planner::Optimization*>(&::hero_local_planner::Optimization::default_instance());
  hcp_opt_ = const_cast< ::hero_local_planner::HomotopyClassPlanner*>(&::hero_local_planner::HomotopyClassPlanner::default_instance());
  recovery_info_ = const_cast< ::hero_local_planner::Recovery*>(&::hero_local_planner::Recovery::default_instance());
}
...
Config::Config(const Config& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_local_planner.Config)
}
...
Config::~Config() {
  // @@protoc_insertion_point(destructor:hero_local_planner.Config)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:hero_local_planner.Config)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:hero_local_planner.Config)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_local_planner.Config)
  return false;
#undef DO_
}
...
void Config::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:hero_local_planner.Config)
  // optional .hero_local_planner.FrameID opt_frame = 1;
  if (has_opt_frame()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
  ...
  // @@protoc_insertion_point(serialize_end:hero_local_planner.Config)
}

::google::protobuf::uint8* Config::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_local_planner.Config)
  // optional .hero_local_planner.FrameID opt_frame = 1;
  if (has_opt_frame()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_local_planner.Config)
  return target;
}
...
void Config::MergeFrom(const Config& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_opt_frame()) {
      mutable_opt_frame()->::hero_local_planner::FrameID::MergeFrom(from.opt_frame());
    }
    if (from.has_trajectory_opt()) {
      mutable_trajectory_opt()->::hero_local_planner::Trajectory::MergeFrom(from.trajectory_opt());
    }
    if (from.has_kinematics_opt()) {
      mutable_kinematics_opt()->::hero_local_planner::Robot::MergeFrom(from.kinematics_opt());
    }
    if (from.has_tolerance_opt()) {
      mutable_tolerance_opt()->::hero_local_planner::GoalTolerance::MergeFrom(from.tolerance_opt());
    }
    if (from.has_obstacles_opt()) {
      mutable_obstacles_opt()->::hero_local_planner::Obstacles::MergeFrom(from.obstacles_opt());
    }
    if (from.has_optimize_info()) {
      mutable_optimize_info()->::hero_local_planner::Optimization::MergeFrom(from.optimize_info());
    }
    if (from.has_hcp_opt()) {
      mutable_hcp_opt()->::hero_local_planner::HomotopyClassPlanner::MergeFrom(from.hcp_opt());
    }
  }
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_recovery_info()) {
      mutable_recovery_info()->::hero_local_planner::Recovery::MergeFrom(from.recovery_info());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
