 ...
 ***************************************************************************/
#ifndef HERO_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_BASE_H
#define HERO_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_BASE_H
...
class GlobalPlannerBase {
 public:
  ...
  virtual hero_common::ErrorInfo Plan(const geometry_msgs::PoseStamped &start,
...
#endif // HERO_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_BASE_H
