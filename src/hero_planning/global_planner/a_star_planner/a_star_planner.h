 ...
 ***************************************************************************/
#ifndef HERO_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
#define HERO_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
...
class AStarPlanner : public GlobalPlannerBase {
 ...
 public:
   ...
   */
  hero_common::ErrorInfo Plan(const geometry_msgs::PoseStamped &start,
 ...
 private:
   ...
   * @return ErrorInfo which is OK if succeed
   */
  hero_common::ErrorInfo SearchPath(const int &start_index,
   ...
   * @return ErrorInfo which is OK if succeed
   */
  hero_common::ErrorInfo GetMoveCost(const int &current_index,
...
hero_common::REGISTER_ALGORITHM(GlobalPlannerBase,
                                 "a_star_planner",
                                 AStarPlanner,
                                 std::shared_ptr<hero_costmap::CostmapInterface>);

} //namespace hero_global_planner

#endif // HERO_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
