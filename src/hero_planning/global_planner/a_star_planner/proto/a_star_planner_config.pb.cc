...
void protobuf_AddDesc_a_5fstar_5fplanner_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\033a_star_planner_config.proto\022\023hero_glob"
    "al_planner\"v\n\022AStarPlannerConfig\022\036\n\021inac"
    "cessible_cost\030\001 \001(\r:\003253\022\033\n\020heuristic_fa"
    "ctor\030\002 \001(\002:\0011\022#\n\025goal_search_tolerance\030\003"
    " \001(\002:\0040.25", 170);
...
AStarPlannerConfig::AStarPlannerConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_global_planner.AStarPlannerConfig)
}
...
AStarPlannerConfig::AStarPlannerConfig(const AStarPlannerConfig& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_global_planner.AStarPlannerConfig)
}
...
AStarPlannerConfig::~AStarPlannerConfig() {
  // @@protoc_insertion_point(destructor:hero_global_planner.AStarPlannerConfig)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:hero_global_planner.AStarPlannerConfig)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_global_planner.AStarPlannerConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_global_planner.AStarPlannerConfig)
  return false;
#undef DO_
}
...
void AStarPlannerConfig::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:hero_global_planner.AStarPlannerConfig)
  // optional uint32 inaccessible_cost = 1 [default = 253];
  ...
  // @@protoc_insertion_point(serialize_end:hero_global_planner.AStarPlannerConfig)
}

::google::protobuf::uint8* AStarPlannerConfig::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_global_planner.AStarPlannerConfig)
  // optional uint32 inaccessible_cost = 1 [default = 253];
  if (has_inaccessible_cost()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_global_planner.AStarPlannerConfig)
  return target;
}
