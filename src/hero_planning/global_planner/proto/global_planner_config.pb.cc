...
void protobuf_AddDesc_global_5fplanner_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\033global_planner_config.proto\022\023hero_glob"
    ...
    "goal_distance_tolerance\030\005 \002(\001\022\034\n\024goal_an"
    "gle_tolerance\030\006 \002(\001", 219);
...
GlobalPlannerConfig::GlobalPlannerConfig()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:hero_global_planner.GlobalPlannerConfig)
}
...
GlobalPlannerConfig::GlobalPlannerConfig(const GlobalPlannerConfig& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:hero_global_planner.GlobalPlannerConfig)
}
...
GlobalPlannerConfig::~GlobalPlannerConfig() {
  // @@protoc_insertion_point(destructor:hero_global_planner.GlobalPlannerConfig)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:hero_global_planner.GlobalPlannerConfig)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:hero_global_planner.GlobalPlannerConfig)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:hero_global_planner.GlobalPlannerConfig)
  return false;
#undef DO_
}
...
void GlobalPlannerConfig::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:hero_global_planner.GlobalPlannerConfig)
  // repeated string name = 1;
  ...
  // @@protoc_insertion_point(serialize_end:hero_global_planner.GlobalPlannerConfig)
}

::google::protobuf::uint8* GlobalPlannerConfig::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:hero_global_planner.GlobalPlannerConfig)
  // repeated string name = 1;
  for (int i = 0; i < this->name_size(); i++) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name(i).data(), this->name(i).length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:hero_global_planner.GlobalPlannerConfig)
  return target;
}
