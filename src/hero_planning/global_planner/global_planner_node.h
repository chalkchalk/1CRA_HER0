 ...
 ***************************************************************************/
#ifndef HERO_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
#define HERO_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
...
class GlobalPlannerNode {
 public:
  ...
  typedef actionlib::SimpleActionServer<hero_msgs::GlobalPlannerAction> GlobalPlannerServer;
 /**
  * @brief Constructor including all initialization and configuration
  */
  GlobalPlannerNode(std::string type);
 ...
 private:
   ...
   */
  void GoalCallback(const hero_msgs::GlobalPlannerGoal::ConstPtr &msg);
  /**
   * @brief Set the state for planning module
   * @param node_state Enumerate State for global planning
   */
  void SetNodeState(hero_common::NodeState node_state);
  /**
   ...
   */
  void SetErrorInfo(hero_common::ErrorInfo error_info);
  /**
  ...
  hero_common::ErrorInfo error_info_;
...
#endif //HERO_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
