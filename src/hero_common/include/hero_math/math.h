...
#ifndef HERO_COMMON_MATH_H
#define HERO_COMMON_MATH_H
...
inline double Cross2D (const hero_common::Point2D &start_point,
                       const hero_common::Point2D &point0,
                       const hero_common::Point2D &point1) {
...
inline bool ConvexVerify(std::vector<hero_common::Point2D> &points) {
...
inline double PointDistance (const hero_common::Point2D &point0,
                             const hero_common::Point2D &point1) {
...
inline double PointToLineDistance (const hero_common::Point2D &point,
                                   const hero_common::LineSegment2D &line) {
...
inline bool CheckLineSegmentsIntersection2D(const hero_common::LineSegment2D &line0,
                                            const hero_common::LineSegment2D &line1,
                                            hero_common::Point2D *intersection = NULL) {
  double s_numer, t_numer, denom, t;
  ...
  hero_common::LineSegment2D aux(line1.Start(), line0.Start());
  ...
  t = t_numer / denom;
  if (intersection) {
    *intersection = line0.Start() + hero_common::Point2D(t * line0.DiffX(), t * line0.DiffY());
  }
...
inline double DistanceSegmentToSegment2D(const hero_common::LineSegment2D &line0, const hero_common::LineSegment2D &line1) {
...
inline double DistancePointToPolygon2D(const hero_common::Point2D &point, const hero_common::Polygon2D &polygon) {
  double dist = HUGE_VAL;
...
inline double DistanceSegmentToPolygon2D(const hero_common::LineSegment2D line,
                                         const hero_common::Polygon2D polygon) {
  double dist = HUGE_VAL;
...
inline double DistancePolygonToPolygon2D(const hero_common::Polygon2D &polygon0,
                                         const hero_common::Polygon2D &polygon1) {
  double dist = HUGE_VAL;
