...
#ifndef HERO_BASE_CHASSIS_H
#define HERO_BASE_CHASSIS_H
...
class Chassis {
 public:
   ...
   */
  Chassis(std::shared_ptr<hero_sdk::Handle> handle);
 ...
 private:
   ...
   */
  void ChassisInfoCallback(const std::shared_ptr<hero_sdk::cmd_chassis_info> chassis_info);

  /**
   * @brief UWB information callback in sdk
   * @param uwb_info UWB information
   */
  void UWBInfoCallback(const std::shared_ptr<hero_sdk::cmd_uwb_info> uwb_info);
   ...
   */
  void ChassisSpeedAccCtrlCallback(const hero_msgs::TwistAccel::ConstPtr &vel_acc);
  ...
  std::shared_ptr<hero_sdk::Publisher<hero_sdk::cmd_chassis_speed>> chassis_speed_pub_;
  //! sdk publisher for chassis speed and acceleration control
  std::shared_ptr<hero_sdk::Publisher<hero_sdk::cmd_chassis_spd_acc>> chassis_spd_acc_pub_;
