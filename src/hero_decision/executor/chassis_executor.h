...
class ChassisExecutor{
 ...
 public:
   ...
   */
  void Execute(const hero_msgs::TwistAccel &twist_accel);
  /**
 ...
 private:
  ...
  //! zero twist with acceleration in form of ROS hero_msgs::TwistAccel
  hero_msgs::TwistAccel zero_twist_accel_;
