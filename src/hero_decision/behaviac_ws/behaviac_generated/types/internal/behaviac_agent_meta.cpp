...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(2004824151u);
			...
			// hero_decision::Robot
			meta = BEHAVIAC_NEW AgentMeta(1382842015u);
			AgentMeta::GetAgentMetas()[2247222791u] = meta;
			meta->RegisterMemberProperty(4056191683u, BEHAVIAC_NEW CMemberProperty< int >("ammo", Set_hero_decision_Robot_ammo, Get_hero_decision_Robot_ammo));
			meta->RegisterMemberProperty(1490941119u, BEHAVIAC_NEW CMemberProperty< int >("combat_effective_num", Set_hero_decision_Robot_combat_effective_num, Get_hero_decision_Robot_combat_effective_num));
			meta->RegisterMemberProperty(3276906981u, BEHAVIAC_NEW CMemberProperty< double >("combat_effectiveness", Set_hero_decision_Robot_combat_effectiveness, Get_hero_decision_Robot_combat_effectiveness));
			meta->RegisterMemberProperty(1089351354u, BEHAVIAC_NEW CMemberProperty< int >("health", Set_hero_decision_Robot_health, Get_hero_decision_Robot_health));
			meta->RegisterMethod(30055375u, BEHAVIAC_NEW CAgentMethod_1< behaviac::EBTStatus, behaviac::string >(FunctionPointer_hero_decision_Robot_EngageRobot));
			meta->RegisterMethod(3462774656u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_hero_decision_Robot_Flee));
			meta->RegisterMethod(4049582804u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_hero_decision_Robot_GoGetBuff));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_hero_decision_Robot_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			meta->RegisterMethod(502968959u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorRemove());
			meta->RegisterMethod(1284393463u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_hero_decision_Robot_WaitForGameStart));

			AgentMeta::Register<behaviac::Agent>("behaviac::Agent");
			AgentMeta::Register<hero_decision::Robot>("hero_decision::Robot");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<hero_decision::Robot>("hero_decision::Robot");
